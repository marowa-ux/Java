...
public class signin extends JFrame implements ActionListener {
    ...
    JLabel label1, imgLabel, imagelbl, label12;
    ...
    public signin() {
        ...
        label12 = new JLabel();
        label12.setText("SIGN UP");
        label12.setBounds(650, 150, 300, 90);
        label12.setFont(f1);
        c.add(label12);
