...
public class crop extends JFrame implements ActionListener {
	...
	crop() {
		...
		mb = new JMenuBar();
		mb.setBounds(100, 10, 150, 30);

		crops = new JMenu("USER INFO");
		crops.setFont(f2);

		season = new JMenu("More");
		season.setFont(f2);
		itm1 = new JMenuItem("Marowa");
		itm1.setFont(f2);
		itm1.addActionListener(this);

		itm2 = new JMenuItem("Jahan");
		itm2.setFont(f2);
		itm2.addActionListener(this);

		itm3 = new JMenuItem("Tisha");
		itm3.setFont(f2);
		itm3.addActionListener(this);

		itm4 = new JMenuItem("Asif");
		itm4.setFont(f2);
		itm4.addActionListener(this);

		itm5 = new JMenuItem("Sabbir");
		itm5.setFont(f2);
