...
public class login extends JFrame implements ActionListener {
    ...
    public login() {
        ...
        logo = new ImageIcon(getClass().getResource("/images/7.png"));
        imgLabel = new JLabel(logo);
        imgLabel.setBounds(500, 90, logo.getIconWidth(), logo.getIconHeight());
        c.add(imgLabel);
        ...
        label1.setBounds(100, 200, 300, 90);
        label1.setFont(f1);
        c.add(label1);

        label1 = new JLabel();
        label1.setText("Shop Dealership");
        label1.setBounds(500, 10, 650, 90);
        label1.setFont(f1);
        c.add(label1);

        label1 = new JLabel();
        label1.setText("User Name");
        label1.setBounds(100, 330, 215, 50);
        label1.setFont(f4);
        c.add(label1);

        tf1 = new JTextField();
        tf1.setBounds(280, 335, 200, 35);
        tf1.setFont(f5);
        c.add(tf1);

        label1 = new JLabel();
        label1.setText("Password");
        label1.setBounds(100, 400, 300, 50);
        label1.setFont(f4);
        c.add(label1);

        tf2 = new JPasswordField();
        tf2.setBounds(280, 405, 200, 35);
        tf2.setFont(f2);
        tf2.setEchoChar('*');
        c.add(tf2);
